...
public class ImageViewTouchBase extends ImageView implements IDisposable {
	...
	final protected float MAX_ZOOM = 1.0f;
	...
	protected void _setImageDrawable( final Drawable drawable, final boolean reset, final Matrix initial_matrix, float maxZoom ) {
		...
		System.out.println("mMaxZoom:"+mMaxZoom);
...
//	OnImageScrollCompleteListener onImageScrollCompleteListener;
//	public void setOnImageScrollCompleteListener(Object obj)
//	{
//		onImageScrollCompleteListener=(OnImageScrollCompleteListener)obj;
//	}
