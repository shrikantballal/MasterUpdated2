...
public class SLNewsURLActivity extends AppSuperActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ticketUrl.getSettings().setJavaScriptEnabled(true);

		newsWebTopLayout = (LinearLayout)findViewById(R.id.news_web_top_bar);
		com.snaplion.util.TopClass.getTopView(SLNewsURLActivity.this,getApplicationContext(),newsWebTopLayout,i.getStringExtra("CatName"),"yes");
	...
	Handler handler = new Handler() {
		...
		protected void onPause() {
			...
			{
				try{
					Utility.killMyApp(getApplicationContext(),SLNewsURLActivity.this);
				}catch (Exception e) {e.printStackTrace();}
			}
			super.onPause();
		}
