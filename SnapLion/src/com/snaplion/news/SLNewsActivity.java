...
public class SLNewsActivity extends AppSuperActivity
{
	@Override
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		upcomingTxt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				upcomingTxt.setTextColor(Color.WHITE);
	...
	protected void onStart() 
	{
		...
		com.snaplion.util.TopClass.getTopView(SLNewsActivity.this,getApplicationContext(),newsTopLayout,categoryName,BackFlag);
		super.onStart();
		...
		public View getView(int position, View convertView, ViewGroup parent) 
		{
			if (convertView == null )
			{
				...
				TextView tv3 = (TextView)convertView.findViewById(R.id.content_txt);
					tv3.setText(values.get(position).getContent());
	...
	public class ImageAdapter1 extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) 
		{
			...
			AQuery aq=new AQuery(MyContext);
			
			Bitmap bitmap = aq.getCachedImage(values.get(position).getImage());
	    	if(bitmap!=null)
	    	{
	    	...
	    	{
	    		aq.id(iv)
	    		.image(values.get(position).getImage(), false, true);
	    	}
...
//			}
	 ...
	 protected Dialog onCreateDialog(int id) {
	     switch (id) {
	         ...
	         case SHOW_NEWS_DIALOG:
	        	 ...
	        	 new AlertDialog.Builder( SLNewsActivity.this)
	        	 .setTitle(str)
	...
	protected void onPause() {
		...
		{
			try{
				Utility.killMyApp(getApplicationContext(),SLNewsActivity.this);
			}catch (Exception e) {e.printStackTrace();}
		}
		super.onPause();
	}
