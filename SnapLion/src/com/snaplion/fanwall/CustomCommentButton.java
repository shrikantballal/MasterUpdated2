...
public class CustomCommentButton extends ImageView
{
	Context context;
	...
	public CustomCommentButton(Context context) 
	{
		super(context);
		this.context=context;
		loadResources();
	}
	public CustomCommentButton(Context context, AttributeSet attrs) 
	{
		super(context, attrs);
		this.context=context;
		loadResources();
	}
	public CustomCommentButton(Context context, AttributeSet attrs, int defStyle) 
	{
	...
	protected void onDraw(Canvas canvas) 
	{
		...
		canvas.drawText(num,getWidth()/2, (getHeight()/2)+(getHeight()/6f), numColor);
  	}
